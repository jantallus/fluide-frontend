  ...
  return (
    <main style={{ width: '100%', overflowX: 'hidden', position: 'relative' }}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .hero-cadeau { background-image: url('/bg-heatmap.svg'), url('/bg-fond.png') !important; background-size: cover, cover !important; background-position: center, center !important; background-color: #312783 !important; }
      ...
      <section className="hero-cadeau" style={{
          ...
          overflow: 'hidden',
          backgroundColor: '#312783', backgroundImage: 'url(/bg-heatmap.svg), url(/bg-fond.png)', backgroundSize: 'cover, cover', backgroundPosition: 'center, center',
        }}>
