  ...
  return (
    <main style={{ width: '100%', overflowX: 'hidden', position: 'relative' }}>
      ...
      <section className="hero-cadeau" style={{
        ...
        {/* Couche 2 : bg-heatmap par-dessus */}
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url(/bg-heatmap.svg)', backgroundSize: 'cover', backgroundPosition: 'center', zIndex: 2 }} />
