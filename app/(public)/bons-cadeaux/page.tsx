  ...
  return (
    <main style={{ width: '100%', overflowX: 'hidden', position: 'relative' }}>
      ...
      <section className="hero-cadeau" style={{
          ...
          display: 'flex', alignItems: 'center', paddingLeft: '10vw', paddingTop: '10vh',
          overflow: 'hidden',
        }}>
        ...
        <div className="hero-animation-block" style={{ position: 'relative', zIndex: 10 }}>
          <h1 style={{ color: 'white', fontSize: 'clamp(2.9rem, 7vw, 4.6rem)', fontWeight: 700, margin: 0, lineHeight: 1.1, textTransform: 'none' }}>Cartes cadeaux</h1>
          <p style={{ color: 'white', fontSize: 'clamp(1.5rem, 2.8vw, 2rem)', fontWeight: 400, marginTop: '8px', opacity: 0.9, textTransform: 'none' }}>Faites plaisir ou faites-vous plaisir !</p>
        </div>
      </section>
